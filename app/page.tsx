...
export default function B2PSimuladorOMIP() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 text-slate-900">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <section className="md:col-span-2 space-y-6">
            ...
            <div className={`relative rounded-2xl bg-white p-5 shadow-sm ${disabledClass}`}>
              ...
              <p className="mb-4 text-sm text-slate-600">
                Preencha os dados para obter o resultado e/ou gravar a simulação. É rápido e direto.
              </p>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-4">
                ...
                <div className="col-span-2">
                  <TextField
                    label="Consumo anual estimado (MWh) (opcional)"
                    type="number"
      ...
      {/* Toast de conversão */}
      {toast.show && (
        <div className="fixed bottom-4 right-4 z-50 rounded-xl bg-slate-900 px-4 py-3 text-sm text-white shadow-lg">
          {toast.text}
        </div>
      )}
    </div>
